...
using Cache =
  System.Collections.Concurrent.ConcurrentDictionary<string, (ModularDoc.Documentation.IDocElement? type,
    System.Collections.Concurrent.ConcurrentDictionary<string, ModularDoc.Documentation.IDocMember>? members)>;
...
namespace ModularDoc.Documentation.Xml
{
    ...
    : IDocResolver
  {
    ...
    public DocResolver(IResolver typeResolver, IDocSettings settings, IModularDocLogger logger, IDefiniteProcess processLogger)
    {
