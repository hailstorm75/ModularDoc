  ...
  : IResolver
{
  ...
  private static readonly HashSet<string> EXCLUDED_NAMESPACES = ["System", "Microsoft"];
  ...
  private static readonly HashSet<string> RECORD_ATTRIBUTES =
  [
  ...
  private void Resolve(string assembly, IGlobalSettings? globalSettings)
  {
    ...
    var group = module
      ...
      // Filter out the namespaces generated by the compiler
  ...
  internal IType? FindReference(object source, IResType type)
  {
    ...
    if (Types.Value.TryGetValue(signature.Namespace, out var value))
