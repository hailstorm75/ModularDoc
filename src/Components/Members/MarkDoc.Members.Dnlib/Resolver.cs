...
namespace MarkDoc.Members.Dnlib
{
  ...
  public class Resolver
    : IResolver
  {
    private readonly IGlobalSettings m_globalSettings;
    private readonly IMemberSettings m_memberSettings;
    ...
    /// Default constructor
    /// </summary>
    public Resolver(IGlobalSettings globalSettings, IMemberSettings memberSettings)
    {
      m_globalSettings = globalSettings;
      m_memberSettings = memberSettings;
    ...
    public Task Resolve()
      => new Task(() => Parallel.ForEach(m_memberSettings.Paths, Resolve));
    ...
    public void Resolve(string assembly)
    {
      bool FilterNamespaces(IGrouping<string, TypeDef> grouping)
      {
        ...
        return !string.IsNullOrEmpty(typeNamespace)
               ...
               && !m_globalSettings.IgnoredNamespaces.Contains(processed);
      }
      ...
      var group = module
        ...
        .Where(type => !m_globalSettings.IgnoredTypes.Contains(type.FullName))
